        ...
        <form onSubmit={handleSubmit(onSubmit)} className={"flex flex-col gap-7"}>
            ...
            <div className="flex flex-col gap-5 lg:flex-row">
                ...
                <div className="flex flex-col gap-2 lg:w-[48%]">
                    ...
                    <input 
                        ...
                        className="form-style"  {...register("lastName")}/>
            ...
            <div className="flex flex-col gap-2">
                ...
                <textarea 
                    ...
                    className="form-style"  {...register("message",{required:true})}/>
                    {errors.message && <span className=" text-yellow-25">Enter your message *</span>}
            </div>

            <button type="submit" className="rounded-md bg-yellow-50 px-6 py-3 text-center text-[13px] font-bold text-black 
                shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)] transition-all duration-200 hover:scale-95 hover:shadow-none 
